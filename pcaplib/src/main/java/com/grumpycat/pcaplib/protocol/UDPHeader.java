...
public class UDPHeader {
	...
	private static final short offset_len = 4; //数据报长度
	...
	public int getTotalLength() {
		return CommonMethods.readShort(mData, mOffset + offset_len) & 0xFFFF;
	}

	public void setTotalLength(int value) {
		CommonMethods.writeShort(mData, mOffset + offset_len, (short) value);
	}
	...
	public String toString() {
		return String.format(Const.LOCALE, "%d->%d", getSourcePort() & 0xFFFF, getDestinationPort() & 0xFFFF);
	}
}
